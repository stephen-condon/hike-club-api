...
- [x] **API-VER-008**: The system shall record API version 1 as sunset on `Thu, 20 Aug 2026 00:00:00 GMT`, API version 2 as sunset on `Tue, 22 Sep 2026 00:00:00 GMT`, and API version 3 as current.
